                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#10161d;border:1px solid #243140;border-radius:16px;overflow:hidden;">
                    <tr>
                        <td style="padding:28px 28px 18px;text-align:center;background:linear-gradient(135deg,#0b1016 0%,#111b24 58%,#073717 100%);">
                            ...
                            <h1 style="margin:18px 0 8px;font-size:30px;line-height:1;color:#ffffff;text-transform:uppercase;letter-spacing:.02em;">Código de acesso</h1>
                            <p style="margin:0;color:#aab7c4;font-size:15px;line-height:1.5;">Use o código abaixo para entrar ou criar sua conta.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:28px;text-align:center;">
                            ...
                            <p style="margin:22px 0 0;color:#aab7c4;font-size:14px;line-height:1.6;">Esse código expira em {{ $expiresInMinutes }} minutos. Se você não pediu esse acesso, pode ignorar este e-mail.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:18px 28px 26px;border-top:1px solid #1f2935;text-align:center;color:#6f7d8b;font-size:12px;">
                            Moto Acessórios - compra segura, atendimento rápido e produtos para sua moto.
                        </td>
                    </tr>
                </table>
            </td>
