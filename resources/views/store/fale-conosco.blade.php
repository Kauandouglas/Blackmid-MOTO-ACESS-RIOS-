...
<section class="contact-hero">
    <div class="wrap contact-hero__inner">
        <div>
            ...
            <h1>Fale Conosco</h1>
            <p>Precisa de ajuda para escolher uma peça, rastrear pedido ou falar sobre pagamento? Nosso time te atende com agilidade.</p>
        </div>
...
<section class="support-section">
    <div class="wrap support-grid">
        <article class="support-card support-card--primary">
            ...
            <h2>WhatsApp</h2>
            <p>Para pedidos, dúvidas rápidas, rastreio e disponibilidade de produtos.</p>
        ...
        <article class="support-card">
            ...
            <h2>E-mail</h2>
            <p>Envie sua solicitação com número do pedido para agilizar o atendimento.</p>
        ...
        <article class="support-card">
            ...
            <h2>Horário</h2>
            <p>Segunda a sexta das 08h às 18h30. Respondemos por ordem de chegada.</p>
...
<section class="contact-info">
    <div class="wrap contact-info__grid">
        <div class="contact-panel">
            ...
            <ul>
                <li><i class="fa-solid fa-box"></i> Dúvidas sobre pedidos e entregas</li>
                <li><i class="fa-solid fa-rotate-right"></i> Trocas e devoluções</li>
                <li><i class="fa-solid fa-credit-card"></i> Pagamento via Mercado Pago</li>
                <li><i class="fa-solid fa-motorcycle"></i> Compatibilidade de peças e acessórios</li>
            </ul>
        </div>
        <div class="contact-panel contact-panel--dark">
            <h2>Antes de chamar</h2>
            <p>Tenha em mãos o número do pedido, modelo da moto ou link do produto. Assim a gente resolve mais rápido.</p>
