    ...
    if (MP_PUBLIC_KEY && window.MercadoPago) {
        ...
        cardForm = mp.cardForm({
            ...
            form: {
                ...
                cardNumber: { id: 'form-checkout__cardNumber', placeholder: '0000 0000 0000 0000', style: secureFieldStyle },
                expirationDate: { id: 'form-checkout__expirationDate', placeholder: 'MM/AA', style: secureFieldStyle },
                securityCode: { id: 'form-checkout__securityCode', placeholder: '000', style: secureFieldStyle },
