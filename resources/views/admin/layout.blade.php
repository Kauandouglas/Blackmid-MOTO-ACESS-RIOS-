    ...
    <aside id="admin-sidebar" class="fixed inset-y-0 left-0 z-50 flex w-[272px] -translate-x-full flex-col overflow-y-auto border-r border-line bg-white lg:static lg:translate-x-0">
        ...
        <div class="px-3 py-4">
            ...
            <nav class="space-y-1">
                ...
                <a href="{{ route('admin.blogs.index') }}" onclick="closeSidebarOnMobile()" class="flex items-center gap-3 rounded-2xl px-3.5 py-2.5 text-sm font-bold transition {{ request()->routeIs('admin.blogs.*') ? 'bg-brand/10 text-brand' : 'text-ink hover:bg-slate-50' }}">
